...
const CartPage = () => {
  ...
  const subtotal = cartItems.reduce(
    (acc, item) => acc + item.gia * item.so_luong,
    0
  );
  ...
  return (
    <div className="cart-page-container">
      <div className="cart-header-title">
        ...
        <p>
          Chào mừng bạn trở lại! Bạn đang có{" "}
          <span className="highlight-count">{totalItems}</span> sản phẩm trong
          giỏ hàng.
        </p>
      </div>
              ...
              <div className="cart-item-card" key={item.id_san_pham}>
                ...
                <div className="item-card__actions">
                  <div className="cart-qty-controls">
                    <button
                      onClick={() =>
                        handleQuantityChange(item.id_san_pham, -1)
                      }
                    >
                      -
                    </button>
                  ...
                  <button
                    ...
                    onClick={() => handleRemoveItem(item.id_san_pham)}
                  >
                    <Trash2 size={15} /> Xóa
                  </button>
                </div>
